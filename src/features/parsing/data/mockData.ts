...
export const initialFiles: FileItem[] = [
  ...
  { id: 6, name: 'temp_0310.xlsx', status: 'complete', progress: 100, parsedItems: 24, anomalies: 0, uploadDate: '2026-02-18', fileSize: '6.1 MB', sheets: 4, uploader: 'TEMP', department: 'TEMP팀' },
];
