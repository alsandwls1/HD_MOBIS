...
export const initialFiles: FileItem[] = [
  ...
  { id: 6, name: 'temp_cost_0310.xlsx', status: 'complete', progress: 100, parsedItems: 32, anomalies: 0, uploadDate: '2026-03-10', fileSize: '2.9 MB', sheets: 3, uploader: 'temp', department: 'temp팀', filePath: 'sample_excel' },
  { id: 7, name: 'temp_cost_0323.xlsx', status: 'complete', progress: 100, parsedItems: 32, anomalies: 0, uploadDate: '2026-03-23', fileSize: '2.9 MB', sheets: 3, uploader: 'temp2', department: 'temp팀', filePath: 'sample_excel' },
];
